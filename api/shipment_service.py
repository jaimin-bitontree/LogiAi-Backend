...
def _serialize(obj) -> dict:
    """Convert a Pydantic model to a plain dict for MongoDB storage."""
    if obj is None:
        return {}
...
async def update_shipment_data(state: dict) -> None:
    ...
    updates = {
        ...
        "language_metadata":  _serialize(state.get("language_metadata")),
        ...
        "validation_result": _serialize(state.get("validation_result")),
